...
SELECT 
    pizzas.size,
    COUNT(order_details.order_details_id) AS Most_common_ordered_Pizza
FROM
    pizzas
        JOIN
    order_details ON pizzas.pizza_id = order_details.pizza_id
GROUP BY pizzas.size
ORDER BY Most_common_ordered_Pizza DESC
LIMIT 1;
...
SELECT 
    ROUND(AVG(quantities), 0) as Average_pizzas_ordered_per_day
FROM
    (SELECT 
